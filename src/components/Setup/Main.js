              ...
              <Col lg={8}>
                <Panel>
                  ...
                  <Switch>
                    ...
                    <Route path={'/setup/register'} component={RegisterAccount}/>
                    <Route path={'/setup/organization'} component={RegisterAccount}/>
                    <Route path={'/setup/finish'} component={RegisterAccount}/>
                  </Switch>
                </Panel>
              </Col>
            </Jumbotron>
